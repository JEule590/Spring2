...
public class OrderService {
	...
	public Orders submitNewOrder(Set<Long> productIds, Long customerId) throws Exception {
		try {
			...
			Orders order = initializeNewOrder(productIds, customer); //initialize or initialized
			return repo.save(order);
		} catch (Exception e) {
			logger.error("Exception occurred while trying to create new order for customer.");
			throw e;
		}
